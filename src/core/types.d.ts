...
export type AgentMXEvent = FileMightChangedEvent | FileStateChangedEvent | AgentFileReadEvent | AgentOperationEvent | AgentCommandExecutedEvent | CognitiveConflictEvent | RecoveryActionEvent;
